...
const firebaseApp = initializeApp({
  apiKey: "AIzaSyDuKUwqeeOICstHEJkBVw7he1RUkB8uZZw",
...
const OUTILS = [
  ...
  { id: "filmfest", nom: "FilmFest Platform", url: "https://filmfestplatform.com", logo: "FFP", couleur: "#8B4513", type: "Soumission", formats: ["court-métrage fiction", "court-métrage documentaire", "court-métrage animation", "long-métrage fiction", "long-métrage documentaire"], perimetre: "International — Europe et Amériques", langue: "Anglais", tarif: "Système de crédits : 3€/crédit, packs dès 14€ pour 5 crédits.", ethique: false, description: "Plateforme de soumission internationale avec système de crédits. Catalogue de festivals européens et américains, interface simple.", forces: ["Système de crédits flexible", "Bonne couverture européenne", "Interface claire"], limites: ["Payant par soumission", "Interface en anglais", "Catalogue plus restreint que FilmFreeway"], ideal: "Cinéastes cherchant une alternative à FilmFreeway avec un système de paiement à l'unité." },
  { id: "festivalscope", nom: "Festival Scope Pro", url: "https://www.festivalscope.com/pro", logo: "FSP", couleur: "#8B0000", type: "Visibilité post-sélection", formats: ["long-métrage fiction", "long-métrage documentaire", "court-métrage fiction", "court-métrage documentaire"], perimetre: "International — festivals partenaires", langue: "Anglais / Français", tarif: "Gratuit pour les films sélectionnés par un festival partenaire.", ethique: false, description: "Plateforme de visibilité pour les films déjà sélectionnés en festivals. Permet aux professionnels accrédités de visionner les films en ligne. Complément, pas une plateforme de soumission.", forces: ["Visibilité auprès des professionnels", "Gratuit pour les films sélectionnés", "Réseau de festivals partenaires"], limites: ["Pas de soumission directe", "Réservé aux films déjà sélectionnés", "Accès conditionné à un festival partenaire"], ideal: "Cinéastes dont le film est déjà sélectionné dans un festival partenaire et souhaitent maximiser leur visibilité professionnelle." },
  { id: "cinando", nom: "Cinando", url: "https://cinando.com", logo: "CND", couleur: "#1A3A5C", type: "Réseau professionnel B2B", formats: ["long-métrage fiction", "long-métrage documentaire", "série"], perimetre: "International — lié au Marché du Film de Cannes", langue: "Français / Anglais", tarif: "Abonnement annuel. Accès inclus avec accréditation au Marché du Film.", ethique: false, description: "Plateforme de réseautage B2B pour les professionnels. Pas une plateforme de soumission directe.", forces: ["Réseau mondial de l'industrie", "Base de données exhaustive", "Marché du Film intégré"], limites: ["Pas de soumission directe", "Payant", "Orienté vente"], ideal: "Producteurs cherchant des partenaires de coproduction ou de distribution." },
];
